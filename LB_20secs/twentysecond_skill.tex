...
\skills{{R/5},{R-Shiny/5},{SQL/4},{SAS/4},{Python/3}}

% Skill text section, each skill must have a value between 0 an 6
\skillstext{
{Machine Learning/ Supervised and Unsupervised Algorithms, Natural Language Processing, Market Basket Analysis, Clustering, Prinicpal Component Analysis, TensorFlow},
{Editors/ RStudio, VIM, Visual Studio Code, Atom},
{Databases/ US Census Bureau, Florida Cancer Data System, SEER}, 
{Other/ Git, ArcGIS Pro, Google Cloud Platform (CE, BQ, AutoML), Data Studio, (R)Markdown, HTML}}
